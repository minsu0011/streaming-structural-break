...
from src.next.registered_inference import implementation_hash as inference_hash
from src.next.log_energy_runtime import source_hash as runtime_hash
...
def train_frozen_candidate(datasets,model_directory_path,spec,*,root=None):
    ...
    descriptor = {'kind':'NEXT_REGISTERED_BINARY','runtime':'log_energy_fast_h','candidate':candidate,
