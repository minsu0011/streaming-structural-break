"""Strict official iterator training for a frozen NEXT variance candidate."""
...
from src.next.final_fitting import fit_all_development,training_feature_names,source_hash as fitting_source_hash
from src.next.candidate_io import model_class
from src.next.inference import implementation_hash as inference_hash
from src.next.fast_variance_initialization import source_hash as runtime_hash
...
def train_frozen_candidate(datasets,model_directory_path,spec,*,root=None):
    ...
    descriptor = {'kind':'NEXT_VARIANCE_PAIR','runtime':'pruned_variance_fast_h','candidate':candidate,
